...
// --- Icons ---
import { BoldIcon } from "@/shared/components/form/editor/tiptap-icons/bold-icon";
import { Code2Icon } from "@/shared/components/form/editor/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/shared/components/form/editor/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/shared/components/form/editor/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/shared/components/form/editor/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/shared/components/form/editor/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/shared/components/form/editor/tiptap-icons/underline-icon";
